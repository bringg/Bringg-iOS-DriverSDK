...
typedef SWIFT_ENUM(NSInteger, AddressType, closed) {
  AddressTypeNone = -1,
...
typedef SWIFT_ENUM(NSInteger, AllowShareWithCustomer, closed) {
...
+ (void)setShared:(Bringg * _Nullable)value;
...
SWIFT_CLASS("_TtC15BringgDriverSDK20BringgSDKInitOptions")
...
SWIFT_CLASS("_TtC15BringgDriverSDK24BringgSDKInitOptionsKeys")
...
typedef SWIFT_ENUM(NSInteger, PickupDropoffOption, closed) {
...
typedef SWIFT_ENUM(NSInteger, StartShiftErrorType, closed) {
