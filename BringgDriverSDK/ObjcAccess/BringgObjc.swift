...
extension BringgObjc {
    @objc public static func initializeSDK(logger: LoggerProtocol? = nil, bringgSDKInitOptions: BringgSDKInitOptions? = nil) -> Error? {
        do {
            if Bringg.shared == nil {
                let driverSDKInitError = Bringg.initializeSDK(
                    logger: logger,
                    bringgSDKInitOptions: bringgSDKInitOptions ?? .default
                )
